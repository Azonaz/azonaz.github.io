...
#### Hints
Stuck and can’t find a move? Use a Hint.
- Highlights a valid pair of numbers on the board
- Does not perform the move automatically — only shows a valid pair

Additional hints can be purchased using shells.

#### Row clearing
- When a full row becomes inactive, it disappears
- Remaining rows shift automatically

### Tips and Tricks
- Look for long-distance connections — they give more points
- Plan ahead before using “Add”
- Clearing rows creates space and opportunities
- Use hints only when truly stuck

### Daily Puzzle
A new puzzle every day with a guaranteed solution.
- No hints or adds
- Complete it to earn shells
